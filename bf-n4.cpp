...
int main(){
    ...
    LL n, m, x, y, a, b;
    LL xx0 = 0, yy0, xx1 = -1, yy1;

    RD(n, m, x, y, a, b); LL d = __gcd(a, b); a /= d, b /= d;

    REP_1(x0, n) REP_1(y0, m){
        FOR_1(x1, x0, n) FOR_1(y1, y0, m){
            if ((x1-x0)*b == a*(y1-y0) && cover(x0, x, x1) && cover(y0, y, y1)){
                if (x1-x0>xx1-xx0){
