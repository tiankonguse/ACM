...
public:
	string getPossibility(vector <int> l) {

		return coin() ? "POSSIBLE" : "IMPOSSIBLE";
	}
};
...
namespace moj_harness {
	...
	int run_test_case(int casenum) {
		...
		case 0: {
			...
			string received__         = DisjointSemicircles().getPossibility(vector <int>(labels, labels + (sizeof labels / sizeof labels[0])));
