// 单纯形解线性规划 By 与星独白/猛犸也钻地 @ 2014.04.02
...
class Simplex {
public:
    static const int SIZE = 5005;   // 略大于约束条件的最大数量
    ...
    double gao(){ // 返回目标函数值，如果是nan则无解，是inf则解无穷大
