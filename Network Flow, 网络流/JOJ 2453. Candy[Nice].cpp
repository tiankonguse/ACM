...
void init(){
    int n1, n2; RD(n1, n2), m = 2;
    s = 0, t = n1 + n2 + 1, n = t + 1, fill(hd, hd + n, 0);
    REP_2_1(i, j, n1, n2) if (RD() == 2) add_edge(i, j+n1, 1);
    REP_1(i, n1) add_edge(s, i, 1);
    tt = -n1; REP_1(i, n2){
        int c; RD(c); tt += c;
        add_edge(i+n1, t, c);
    }
